function [ costMat, minCutNodes] = PRMAnalysisWithSafety( A,configs_weight, startNodes,goalNodes,total_config)
...
for i=1:C
    ...
    Ai(2:noMidNodes+1,noMidNodes+2:2*noMidNodes+1) = repmat(configs_weight(midNodes),1,noMidNodes).*eye(noMidNodes);
...
%     Gi = digraph(Ai);
%     h = plot(Gi,'EdgeLabel',Gi.Edges.Weight);
    %
