function [ output_args ] = safePathsWithClearance( input_args )
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

close all
adj_directory = '/home/khan/phd_ws/traversability/adjacency/long_roads/road_long';
config_directory = '/home/khan/phd_ws/traversability/configs/long_roads/road_long';
...
% configs_clearance = neighborBasedConfigsClearance(configs,x_config_count,y_config_count,theta_config_count,valid_nodes,invalid_nodes);
configs_clearance = configs(:,6);

% get prm adjacency list along with their distances
prm_adj_without_clearance = [[prm_adj_list(:,1:2) prm_distances];[total_config total_config 0]];
...
max(configs_clearance(minCutNodes))
