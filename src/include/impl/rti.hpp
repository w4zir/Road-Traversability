...
pcl::RTI<PointT>::loadParameters ()
{
	...
	min_theta_	=	cf.Value("prm_parameters","min_theta");
	max_theta_	=	cf.Value("prm_parameters","max_theta");
	negative_obs_threshold_	=	cf.Value("prm_parameters","negative_obs_threshold");
	config_neighbour_radius_	=	cf.Value("prm_parameters","config_neighbour_radius");
	prm_step_size_	=	cf.Value("prm_parameters","prm_step_size");
	...
	vehicle_heigt_	=	vcf.Value(vehicle_id_,"vehicle_heigt");
	wheelbase_	=	vcf.Value(vehicle_id_,"wheelbase");
	front_track_	=	vcf.Value(vehicle_id_,"front_track");
	ground_clearance_	=	vcf.Value(vehicle_id_,"ground_clearance");
	tire_width_	=	vcf.Value(vehicle_id_,"tire_width");

}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> std::string
pcl::RTI<PointT>::getVehicleId () const
{
	return vehicle_id_;
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::setVehicleId (std::string vehicle_id)
{
	vehicle_id_ = vehicle_id;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::RTI<PointT>::getRandomConfigsFlag () const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::setRandomConfigsFlag (bool is_random_configs)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::RTI<PointT>::getImportConfigsFlag () const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::setImportConfigsFlag (bool is_import_configs)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::getRTIAdjacencyList (std::vector< std::pair<int,int> >& RTI_graph)
{
	RTI_graph = RTI_graph_;
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::setGoalBiasProbability (float goal_bias)
{
...
pcl::RTI<PointT>::getGoalBiasProbability () const
{
	return (goal_bias_);
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::setObstaclesInfo (Eigen::MatrixXf &obstacles_info)
{
	obstacles_info_ = obstacles_info;
	is_obstacle_known_ = true;
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::getObstaclesInfo (Eigen::MatrixXf &obstacles_info)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::getEdgeAngelRatios (std::vector<float> &edge_ratios)
{
	edge_ratios = edge_angle_ratio_;
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> int
pcl::RTI<PointT>::getConfigCounter () const
{
...
pcl::RTI<PointT>::getConfigurationsValidityStatus ()
{
...
pcl::RTI<PointT>::getConfigurationsClearance ()
{
...
pcl::RTI<PointT>::getConfigurations ()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::getConfigurationsOnly (Eigen::MatrixXf &vehicle_configs)
{
	generateRandomConfigurations ();
	vehicle_configs = vehicle_configs_;
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::setConfigurations (Eigen::MatrixXf vehicle_configs)
{
...
pcl::RTI<PointT>::generateRandomConfiguration ()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> int
pcl::RTI<PointT>::findQrandNearestNeighbor (Eigen::Vector3f qrand)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> float
pcl::RTI<PointT>::config_dist (Eigen::Vector3f qrand, Eigen::Vector4f qnear)
{
...
pcl::RTI<PointT>::findOptimalConfig (Eigen::Vector3f qrand, Eigen::Vector4f qnear)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> int
pcl::RTI<PointT>::checkConfigSafety (Eigen::Vector4f config)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::addStartConfigurations ()
{
	config_counter_ = 0;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::findConfigNeighbours ()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> Eigen::MatrixXf
pcl::RTI<PointT>::getConfigCircluarCenters (Eigen::Vector4f config)
{
...
//			RTI_graph.push_back(std::make_pair(q_near_idx,config_counter_));
...
//	RTI_graph_ = RTI_graph;
//	std::cout << "RTI graph generated." << std::endl;
//	if(is_goal)
//	{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::validateConfigurations ()
{
...
pcl::RTI<PointT>::clearanceUsingInvalidConfigs ()
{
	...
	for (int c_idx=0; c_idx < config_count; c_idx++)
	{
		float min_clearance = 1000; // initialize to large number
		if (config_collision_status_[c_idx] == 1)
		{
			for (int i_idx=0; i_idx < config_count; i_idx++)
			{
				if (c_idx != i_idx && config_collision_status_[i_idx] == 0)
				{
						float clearance = computeConfigDistance(vehicle_configs_.row(c_idx).head(3),vehicle_configs_.row(i_idx).head(3));
			...
			config_clearance_[c_idx] = min_clearance;
			//std::cout << min_clearance << std::endl;
		}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::RTI<PointT>::findConfigsConnectivity (Eigen::Vector4f c_config, Eigen::Vector4f n_config, Eigen::MatrixXf config_circles)
{
...
pcl::RTI<PointT>::generatePRMGraph ()
{
		...
		//for (int c_idx=0; c_idx <  config_count; c_idx++)
	{
		...
		} else
		{
			...
			//	std::cout <<"neighbor id:"<< n_idx << "\t neighbor_count:" << neighbor_count << "\t collision:" << config_collision_status_[neighbor_indx] << std::endl;
				...
				} else
				{
					...
					// std::cout <<"neighbor_ratio:"<< neighbor_ratio << std::endl;
					if(neighbor_ratio != -1)
					{
				//		std::cout <<"c_config:"<< c_config.transpose() << "\t n_config" << n_config.transpose() << std::endl;
				// c_config = Eigen::Vector4f(-0.3305,    2.1958, 108.3030,0);
				// n_config = Eigen::Vector4f(-0.7446,    3.9783,   97.1820,0);
				...
				// exit(0);
						...
						for (int s_idx=0; s_idx < n_sub_configs.rows(); s_idx++)
						{
							...
							// std::cout << "got vehicle state" << std::endl;
							//		std::cout << "vehicle state: " << vehicle_state << std::endl;
							//		float state_min_x = vehicle_state.row(1).leftCols(4).minCoeff();
							...
							{
								if (s_idx == (n_sub_configs.rows()-1))
								{
									RTI_graph.push_back(std::make_pair(c_idx,neighbor_indx));
										// std::cout << "RTI_graph pushed" << std::endl;
									edge_angle_ratio_.push_back(neighbor_ratio);
								}
							}
						}
					}
	...
	RTI_graph_ = RTI_graph;
 std::cout << " Graph generated with edges:\t" << RTI_graph.size() << std::endl;
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::generateConfigurations ()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::generateQuasiRandomConfigurations ()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::RTI<PointT>::generateRandomConfigurations ()
{
	int config_count = config_x_count_ * config_y_count_ * config_theta_count_;
	vehicle_configs_ = Eigen::MatrixXf::Constant(config_count,4,-1000);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::RTI<PointT>::collisionChecker (Eigen::MatrixXf vehicle_state)
{
	/*
	...
	if(tyres_min_x < (road_min_x_ + tire_width_/2) || tyres_max_x > (road_max_x_ - tire_width_/2))
	{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> int
pcl::RTI<PointT>::collisionAndSafetyChecker (Eigen::MatrixXf vehicle_state)
{
	/*
	 *  Check if any of the tyres are outside road bounds.
	 */
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> int
pcl::RTI<PointT>::collisionCheckerWithKnownObstacles (Eigen::MatrixXf vehicle_state)
{
	/*
	 *  Check if any of the tyres are outside road bounds.
	 */
	...
	{
		//		if (obstacles_info_(obs_idx,2) <= 0)
		//		{
		//			continue;
		//		}
		for (int tyre_id=0; tyre_id < 4; tyre_id++)
		...
		//		// For rectangular obstacle
		//		for (int tyre_id=0; tyre_id < 4; tyre_id++)
		//		{
		//			float tyre_x = vehicle_state(0,4+tyre_id);
		//			float tyre_y = vehicle_state(1,4+tyre_id);
		//			float tyre_z = vehicle_state(2,4+tyre_id);
		//			Eigen::Vector3f tire_info(tyre_x,tyre_y,tire_width_/2);
		////			std::cout << tire_info << std::endl;
		//			Eigen::MatrixXf rect_obs(3,4);
		//			rect_obs << -4, obstacles_info_(0,0), obstacles_info_(0,0), -4, -10, -10, 10, 10, 0, 0, 0, 0;
		////			std::cout << rect_obs << std::endl;
		////			exit(0);
		//			bool tire_in_rect_obs = checkCircleCollisdeWithRectangle(tire_info, rect_obs);
		//			if (tire_in_rect_obs)
		//			{
		//				return -1;
		//			}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> float
pcl::RTI<PointT>::computeConfigClearance (Eigen::Vector3f config, Eigen::MatrixXf vehicle_state)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::RTI<PointT>::checkDemUnderVehicle (int d_idx, Eigen::MatrixXf vehicle_body_state)
{
	/*
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::RTI<PointT>::checkPointUnderVehicle (Eigen::Vector3f p, Eigen::MatrixXf vehicle_body_state)
{
	/*
	 * A,B,C and D are corners of the vehicle state. let p be the point then the equation is (0 <= AP.AB <= AB.AB) && (0 <= AP.AD <= AD.AD)
	 */
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::RTI<PointT>::checkCircleCollisdeWithRectangle (Eigen::Vector3f circle, Eigen::MatrixXf vehicle_body_state)
{
	Eigen::Vector3f circle_center (circle(0),circle(1),0);
	bool is_point_under_vehicle = checkPointUnderVehicle (circle_center,vehicle_body_state);
	...
	Eigen::Vector3f ap_vector = p - a_point;
	Eigen::Vector3f ab_vector = b_point - a_point;
	float ab_dot = ab_vector.dot(ab_vector)/ab_vector.norm();
	float pab_dot = ap_vector.dot(ab_vector)/ab_vector.norm();
	float p_ab_line_dist = std::sqrt(std::pow(ap_dist,2) - std::pow(pab_dot,2));
	...
	float bc_dot = bc_vector.dot(bc_vector)/bc_vector.norm();
	float pbc_dot = bp_vector.dot(bc_vector)/bc_vector.norm();
	float p_bc_line_dist = std::sqrt(std::pow(bp_dist,2) - std::pow(pbc_dot,2));
	...
	float cd_dot = cd_vector.dot(cd_vector)/cd_vector.norm();
	float pcd_dot = cp_vector.dot(cd_vector)/cd_vector.norm();
	float p_cd_line_dist = std::sqrt(std::pow(cp_dist,2) - std::pow(pcd_dot,2));
	...
	float da_dot = da_vector.dot(da_vector)/da_vector.norm();
	float pda_dot = dp_vector.dot(da_vector)/da_vector.norm();
	float p_da_line_dist = std::sqrt(std::pow(dp_dist,2) - std::pow(pda_dot,2));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::RTI<PointT>::checkDemInsideTiresBoundingBoxes (int d_idx, Eigen::MatrixXf clearance_bounding_boxes)
{
	/*
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> float
pcl::RTI<PointT>::computePositiveObstacleDistance (int d_idx, Eigen::MatrixXf vehicle_body_state)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> float
pcl::RTI<PointT>::computeNegativeObstacleDistance (int d_idx, Eigen::MatrixXf vehicle_body_state)
{
	Eigen::Vector3f dem_point(cloud_dem_->points[d_idx].x, cloud_dem_->points[d_idx].y, cloud_dem_->points[d_idx].z);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::RTI<PointT>::tyreClusterCollisionProcessing (int d_idx)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::RTI<PointT>::bodyClusterCollisionProcessing (int d_idx)
{
	std::vector<cluster_stats_> dem_cluster = dem_clusters_[d_idx];
	if(dem_cluster.size() == 0)
	{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> Eigen::MatrixXf
pcl::RTI<PointT>::getVehicleState (Eigen::Vector3f v_config)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> Eigen::MatrixXf
pcl::RTI<PointT>::getVehicleStateWithClearance (Eigen::Vector3f v_config)
{
	Eigen::MatrixXf vehicle_state_origin(3,8);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> Eigen::MatrixXf
pcl::RTI<PointT>::getClearanceBoundingBoxes (Eigen::Vector3f v_config)
{
...
pcl::RTI<PointT>::computeRTI ()
{
	...
	bool is_ready = preProcessingRTI();
	if(!is_ready)
	{
		std::cout << "Error, issue in pre-processing for RTI." << std::endl;
		return;
	}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::RTI<PointT>::preProcessingRTI ()
{
	std::cout << "Pre-processing for RTI." << std::endl;
...
//pcl::RTI<PointT>::getRTIVisibilityCloud ()
//{
