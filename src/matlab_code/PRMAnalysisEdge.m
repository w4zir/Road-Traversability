function [ costMat, minCutNodes] = PRMAnalysisEdge( A,startNodes,goalNodes,total_config)
...
for i=1:C
    ...
    Ai = zeros(noMidNodes+2,noMidNodes+2);
    ...
    Ai(2:noMidNodes+1,2:noMidNodes+1) = A(midNodes,midNodes);
...
%     Ai(noMidNodes+2:2*noMidNodes+1,2:noMidNodes+1) = 1000*A(midNodes,midNodes);
    ...
    Ai(2:noMidNodes+1,noMidNodes+2) = 1000*g2Mid(midNodes)';
