...
pcl::PRT<PointT>::getVehicleId () const
{
	return vehicle_id_;
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::PRT<PointT>::setObstaclesInfo (Eigen::MatrixXf &obstacles_info)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::PRT<PointT>::getObstaclesInfo (Eigen::MatrixXf &obstacles_info)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::PRT<PointT>::getEdgeAngelRatios (std::vector<float> &edge_ratios)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::PRT<PointT>::getConfigurationsOnly (Eigen::MatrixXf &vehicle_configs)
{
							...
							} else
							{
								if (s_idx == (n_sub_configs.rows()-1))
								{
									prt_graph.push_back(std::make_pair(c_idx,neighbor_indx));
										// std::cout << "prt_graph pushed" << std::endl;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> int
pcl::PRT<PointT>::collisionCheckerWithKnownObstacles (Eigen::MatrixXf vehicle_state)
{
	/*
	 *  Check if any of the tyres are outside road bounds.
	 */
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::PRT<PointT>::checkPointUnderVehicle (Eigen::Vector3f p, Eigen::MatrixXf vehicle_body_state)
{
	/*
	 * A,B,C and D are corners of the vehicle state. let p be the point then the equation is (0 <= AP.AB <= AB.AB) && (0 <= AP.AD <= AD.AD)
	 */
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> bool
pcl::PRT<PointT>::checkCircleCollisdeWithRectangle (Eigen::Vector3f circle, Eigen::MatrixXf vehicle_body_state)
{
