function [ costMat, minCutNodes] = PRMAnalysisWeighted(A,degree,startNodes,goalNodes,total_config)
...
for i=1:C
    ...
    Ai(2:noMidNodes+1,noMidNodes+2:2*noMidNodes+1) = repmat(degree(midNodes),1,noMidNodes).*eye(noMidNodes);
